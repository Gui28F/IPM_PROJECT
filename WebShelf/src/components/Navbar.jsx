...
const Navbar = () => {
    ...
    return (
        <nav
            ...
            <ul className='hidden md:flex navbar-center-items'>
            ...
            <div className={isSearching ? 'hidden md:flex navbar-searching' : 'hidden md:flex navbar-search-container' }>
                <form
                    onSubmit={handleSearchSubmit}
                    className={isSearching ? 'flex p-1 text-black bg-gray-100/90 max-w-[700px] navbar-search-bar-active' : 'flex p-1 text-black bg-gray-100/90 max-w-[700px] navbar-search-bar'}
                >
                    <input
                        ref={inputRef}
                        type='text'
